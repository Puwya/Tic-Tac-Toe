...
void displayInstructions() {
  ...
  std::cout << "<p>\nWhen selecting the option to set a name "
            ...
            << "If set names option is not selected then default names will take "
               "place.\n</p>\n";
  std::cout << "<p>\n"
            << "                                      How to Play EX. 1                  "
               "                           \n"
            ...
            << "PlayerO's turn! What's your play?_ _\n\n\n\n"

            << "                                     How not to Play EX. 2               "
               "                          \n "
            << "                                                             Spot is "
               "taken on the board! Retry     \n "
            << "         1       2       3                                    "
            << "         1       2       3      \n "
            << "      [1][1] | [1][2] | [1][3]                                "
            << "      [1][1] | [1][2] | [1][3]  \n "
            ...
            << "\nPlayerO's turn! What's your play? 2 2                       "
            << "PlayerO's turn! What's your play?_ _\n</p>\n";
